...
async function sendEscalationEmail({ to, title, description, draftContent }) {
...
async function sendReminderEmail({ to, title, hoursAgo }) {
  await send({
    to,
...
async function sendUrgentEmail({ to, title }) {
  await send({
    to,
