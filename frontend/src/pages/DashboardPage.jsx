  ...
  return (
    <div className="flex gap-6">
      ...
      <div className="flex-1 min-w-0 space-y-5">
        ...
        {/* New account: a clear next step instead of a page of zeros */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="card">
            ...
            {maintenance.length === 0 ? (
              <p className="text-sm text-slate-500 py-4 text-center">No maintenance requests yet. Tenant requests will appear here.</p>
            ) : (
