...
const COPY = {
  LANDLORD: {
    ...
    subtitle: 'Set up Farik for your rentals in about a minute. No credit card needed.',
    after: '/onboarding',
  },
  TENANT: {
 ...
 * the person lands afterwards; landlords go straight into onboarding.
 */
        ...
        <>
          ...
          {role === 'TENANT' ? (
            ...
            <p className="mt-3 text-slate-500">
              ...
              <Link to="/signup/tenant" className="font-medium text-slate-700 underline-offset-4 hover:underline">Create a tenant account</Link>
            </p>
          )}
        </>
      }
